...
- (void)setStatus:(NSString *)string {
    ...
    if(string) {
        ...
        NSDictionary *dic = [NSDictionary dictionaryWithObjectsAndKeys:self.stringLabel.font,NSFontAttributeName, nil];
        CGSize stringSize = [string boundingRectWithSize:CGSizeMake(200,300) options:NSStringDrawingTruncatesLastVisibleLine|NSStringDrawingUsesLineFragmentOrigin|NSStringDrawingUsesFontLeading attributes:dic context:nil].size;
