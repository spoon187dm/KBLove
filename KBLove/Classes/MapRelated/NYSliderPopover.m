...
- (NYPopover *)popover
{
    if (_popover == nil) {
        ...
        _popover = [[NYPopover alloc] initWithFrame:CGRectMake(self.frame.origin.x, self.frame.origin.y - _popoverHeight, _popoverWidth, _popoverHeight)];
...
{
    self.popover.textLabel.text = text;
    [self updatePopoverFrame];
}
